...
public class JSONToNeo4J implements IServiceToNeo4J {
	 ...
	 */
	public JSONToNeo4J() throws FileNotFoundException, IOException, NoSuchMethodException, SecurityException {
		
		Neo4JServiceManager n4jm = new Neo4JServiceManager(); 		
		
		IJiraArtifactService artifactService = new JSONArtifactService();
